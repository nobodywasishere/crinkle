...
module TestTypedFilters
  Crinkle.define_filter :typed_upper,
    ...
    # __param_value is generated by the macro
    __param_value.to_s.upcase
  end

  # Debug: manually implement what the macro should generate
  def self.__register_filter_typed_truncate_manual(env : Crinkle::Environment) : Nil
  ...
  Crinkle.define_filter :typed_truncate,
    ...
    defaults: {length: 80},
    returns: String,
    doc: "Truncate string to length" do
    str = __param_value.to_s
    len = __param_length.to_s.to_i? || 80
    str.size > len ? str[0...len] + "..." : str
  end

  def self.register(env : Crinkle::Environment) : Nil
    __register_filter_typed_upper(env)
    __register_filter_typed_truncate(env)
    __register_filter_typed_truncate_manual(env)
  end
end
...
module TestTypedTests
  Crinkle.define_test :typed_even,
    params: {value: Number},
    doc: "Check if number is even" do
    # __param_value is generated by the macro
    val = __param_value.to_s.to_i64? || 0_i64
    val % 2 == 0
  end

  def self.register(env : Crinkle::Environment) : Nil
    __register_test_typed_even(env)
  end
end
...
module TestTypedFunctions
  Crinkle.define_function :typed_greet,
    ...
    returns: String,
    doc: "Create a greeting" do
    # __param_name and __param_greeting are generated by the macro
    "#{__param_greeting}, #{__param_name}!"
  end

  def self.register(env : Crinkle::Environment) : Nil
    __register_function_typed_greet(env)
  end
end
...
describe "Crinkle typed macros" do
  ...
  describe "Callable with annotations" do
    it "generates callable schema" do
      schema = TestFormatter.__crinkle_callable_schema
